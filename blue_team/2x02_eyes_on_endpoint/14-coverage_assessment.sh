...
`[ $a.blind[] | {severity:"blind", description:.action, platform:.platform, technique:.technique,`
...
`+ [ $a.partial[] | {severity:"partial", description:.action, platform:.platform, technique:.technique,`
